            ...
            {cart.map((producto)=> {
                return (
                 <div key={producto.id} className=" row mt-4  d-flex justify-content-around text-center align-items-center">
                    <td className="col-2 d-none d-md-block"><img src={producto.imagen} width="80" className="img-fluid" alt={producto.descripcion} /></td>
                    <td className="col-2 text ">{producto.nombre}</td>
